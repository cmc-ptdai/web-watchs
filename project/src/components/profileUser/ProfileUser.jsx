        ...
        <>
          <div className="profile-title">
            ...
            <div className="profile-title-changePassword">
              {user.password !== '' && (
                <Button type="primary" onClick={ShowChangePwd}>
                  thay đổi mật khẩu
                </Button>
              )}
              <Modal
              ...
              >
                <Form name="basic" form={form} onFinish={onFinishChangePassword}>
              ...
              <div className="profile-info">
                {user && (
                  <>
                    ...
                    <div className="profile-info-item">
                      <span>Ngày sinh:</span>{' '}
                      {user.birthday === '' ? 'Chưa có thông tin' : FormatDate()}
                    </div>
                    <div className="profile-info-item">
                      <span>Số điện thoại:</span>{' '}
                      {user.phone === '' ? 'Chưa có thông tin' : user.phone}
                    </div>
                    <div className="profile-info-item">
                    ...
                    <div className="profile-info-item">
                      <span>Địa chỉ:</span>{' '}
                      {user.address === '' ? 'Chưa có thông tin' : user.address}
                    </div>
                    <div className="profile-info-item">
                      <span>Giới tính:</span>{' '}
                      {user.gender === '' ? 'Chưa có thông tin' : user.gender}
                    </div>
                  </>
                )}
